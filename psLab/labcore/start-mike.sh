...
_LAB_MAIN_DIR=/net/user/mfbaker/psLab/trunk

_LAB_LIB_DIR="/net/user/mfbaker/psLab/trunk/lib/${OS_ARCH}"
...
_LAB_DATA_DIR=/net/user/mfbaker/psLab/trunk/data
_LAB_RESULTS_DIR=/net/user/mfbaker/psLab/trunk/results
