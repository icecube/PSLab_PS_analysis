#ifndef LLH_MULTIBOXANALYSISFN_H_
#define LLH_MULTIBOXANALYSISFN_H_
...
class MultiBoxAnalysisFn : public AnalysisFn {
    public: 

      vector<NewLlhBoxTime*> analysisFnVect_; // this needs to be specifically
      ...
      virtual void AddAnalysisFn(AnalysisFn* llh) {
          NewLlhBoxTime* llh1 = dynamic_cast<NewLlhBoxTime*>(llh);
      ...
      virtual void GetFlareGuess(bool UseE, double & Guess_nsrc, double & Guess_gamma, double & Guess_boxmin, double & Guess_boxmax);
...
#endif // LLH_MULTIBOXANALYSISFN_H_
